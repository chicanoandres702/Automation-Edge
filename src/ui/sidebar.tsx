...
const SIDEBAR_MENU_WIDTH_CLASSES = [
  "w-1/4",
  "w-1/3",
  "w-1/2",
  "w-2/3",
...
>(({ className, showIcon = false, ...props }, ref) => {
  const [widthClass, setWidthClass] = React.useState<string>(SIDEBAR_MENU_WIDTH_CLASSES[2])

  React.useEffect(() => {
    setWidthClass(
      SIDEBAR_MENU_WIDTH_CLASSES[Math.floor(Math.random() * SIDEBAR_MENU_WIDTH_CLASSES.length)]
    )
  }, [])
