...
export function AppSidebar({ 
  ...
  return (
    <Sidebar variant="inset" side="left" className="border-r border-white/5 bg-sidebar overflow-hidden">
      <SidebarHeader className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center neon-glow-primary">
      ...
      <SidebarContent className="px-5 py-2 flex flex-col gap-6 overflow-hidden">
      ...
      <SidebarFooter className="p-5 border-t border-white/5">
        <div className="space-y-4">
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all cursor-pointer group">
            <div className="w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center ring-2 ring-primary/20 transition-all group-hover:ring-primary/40">
              <User className="w-4 h-4 text-primary" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-black truncate uppercase tracking-tight">Operator_Alpha</p>
              <p className="text-[8px] text-muted-foreground truncate font-mono uppercase">auth::root_nexus</p>
            </div>
            <LogOut className="w-3.5 h-3.5 text-muted-foreground/50 group-hover:text-destructive transition-colors" />
          </div>
          <Button variant="outline" className="w-full justify-start gap-3 border-white/5 bg-transparent text-[10px] font-black uppercase tracking-widest h-10 rounded-xl hover:bg-primary/5 hover:border-primary/20 transition-all">
